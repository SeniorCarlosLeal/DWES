...
<body>
  <center>
    <h2>Bienvenido al portal de compras web</h2>
      ...
      <ul id="operaciones">
        <li><a href="./PHP/altaCategoria.php">Dar de alta una categoría de producto</a> </li>
        <li><a href="./PHP/altaProducto.php">Dar de alta una producto</a> </li>
        <li><a href="./PHP/altaAlmacen.php">Dar de alta un almacén</a> </li>
        <li><a href="./PHP/almacenaProducto.php">Almacenar un producto en un almacén</a> </li>
        <li><a href="./PHP/consultarStock.php">Consultar el stock de productos</a> </li>
        <li><a href="./PHP/consultarStockAlmacenes.php">Consultar el stock de cada almacén</a> </li>
        <li><a href="./PHP/altaCliente.php">Dar de alta a un cliente</a> </li>
        <li><a href="./PHP/compraProducto.php">Comprar un producto</a> </li>
        <li><a href="./PHP/comprasClientes.php">Consultar las compras de un cliente</a> </li>
