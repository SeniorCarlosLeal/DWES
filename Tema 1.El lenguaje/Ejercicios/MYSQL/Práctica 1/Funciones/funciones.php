...
function verListadoEmpleados($departamento,$baseDatos){
  ...
  function verListadoHistoricoEmpleados($codDepartamento,$baseDatos){
    ...
    function comprobarEmpleadosEnFecha($fecha,$baseDatos){
      ...
      function verSalariosPorDepartamentos($departamento,$baseDatos){
        try{

          $stmt = $baseDatos->prepare("SELECT nombre, salario from empleado,departamento,emple_depart
                                      WHERE empleado.dni=emple_depart.dni and departamento.cod_dpto=emple_depart.cod_dpto and departamento.nombre_dpto='$departamento' and
                                      fecha_fin is null");
          $stmt->execute();
      ...
      function totalSalarioDpto($departamento,$baseDatos){
        try{

          $stmt = $baseDatos->prepare("SELECT sum(salario) from empleado,departamento,emple_depart
                                      WHERE empleado.dni=emple_depart.dni and departamento.cod_dpto=emple_depart.cod_dpto and departamento.nombre_dpto='$departamento' and
                                      fecha_fin is null");
          $stmt->execute();
